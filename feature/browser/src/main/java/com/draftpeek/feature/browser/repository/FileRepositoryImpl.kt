 ...
 */
class FileRepositoryImpl @Inject constructor(@param:ApplicationContext private val context: Context) : FileRepository {
    ...
    override suspend fun readFile(uri: Uri): FileContentResult = withContext(Dispatchers.IO) {
        try {
