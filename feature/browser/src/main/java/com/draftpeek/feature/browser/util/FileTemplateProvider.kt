...
object FileTemplateProvider {
    ...
    fun getHelloWorldTemplate(language: String, extension: String): String {
...
<body>
    <h1>Hello, World!</h1>
            ...
            "CSS" -> """/* Hello World in CSS - add to your HTML */
body::after {
    content: "Hello, World!";
}"""
...
\end{document}"""
    ...
    fun getClassTemplate(language: String, extension: String): String {
        return when (language) {
            "Java" -> """public class Main {
    ...
    constructor() {
            ...
            "C" -> """/* C does not have built-in classes */
