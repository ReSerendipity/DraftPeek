...
object BrandElevation {
     ...
     */
    fun Modifier.shadowSm(shape: RoundedCornerShape = RoundedCornerShape(0.dp)): Modifier = this.shadow(
        elevation = 1.dp,
        shape = shape,
        clip = false,
     ...
     */
    fun Modifier.shadowMd(shape: RoundedCornerShape = RoundedCornerShape(0.dp)): Modifier = this.shadow(
        elevation = 2.dp,
        shape = shape,
        clip = false,
     ...
     */
    fun Modifier.shadowLg(shape: RoundedCornerShape = RoundedCornerShape(0.dp)): Modifier = this.shadow(
        elevation = 4.dp,
        shape = shape,
        clip = false,
     ...
     */
    fun Modifier.shadowXl(shape: RoundedCornerShape = RoundedCornerShape(0.dp)): Modifier = this.shadow(
        elevation = 8.dp,
        shape = shape,
        clip = false,
     ...
     */
    fun Modifier.shadowFab(shape: RoundedCornerShape = RoundedCornerShape(0.dp)): Modifier = this.shadow(
        elevation = 6.dp,
        shape = shape,
        clip = false,
