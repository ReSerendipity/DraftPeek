 ...
 */
@Deprecated("Use com.draftpeek.core.designsystem.theme.DraftPeekSpacing instead", ReplaceWith("DraftPeekSpacing", "com.draftpeek.core.designsystem.theme"))
val DraftPeekSpacing = com.draftpeek.core.designsystem.theme.DraftPeekSpacing

@Deprecated("Use com.draftpeek.core.designsystem.theme.PrototypeSpacing instead", ReplaceWith("PrototypeSpacing", "com.draftpeek.core.designsystem.theme"))
