 ...
 */
@Deprecated(
    "Use com.draftpeek.core.designsystem.theme.Shapes instead",
    ReplaceWith("Shapes", "com.draftpeek.core.designsystem.theme")
)
val Shapes: Shapes get() = com.draftpeek.core.designsystem.theme.Shapes

@Deprecated(
    "Use com.draftpeek.core.designsystem.theme.BrandShapes instead",
    ReplaceWith("BrandShapes", "com.draftpeek.core.designsystem.theme")
)
val BrandShapes = com.draftpeek.core.designsystem.theme.BrandShapes

@Deprecated(
    "Use com.draftpeek.core.designsystem.theme.PrototypeShapes instead",
    ReplaceWith("PrototypeShapes", "com.draftpeek.core.designsystem.theme")
)
