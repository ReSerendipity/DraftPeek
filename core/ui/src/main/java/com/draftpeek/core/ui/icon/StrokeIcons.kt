 ...
 */
data class StrokeIconDef(
    val name: String,
    val items: List<StrokeItem>,
)
...
object StrokeIcons {
    ...
    val FolderOutline: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                stroke(1.8f, listOf(Offset(3f, 7f),
                    Offset(4.4f, 5f),
                    Offset(9f, 5f),
                    Offset(11f, 7f),
                    Offset(19f, 7f),
    ...
    val Person: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                ...
                stroke(1.8f, listOf(Offset(4f, 20f),
                    Offset(6.6f, 16.6f),
                    Offset(9.6f, 14.8f),
                    Offset(12f, 14f),
                    Offset(15.5f, 15.2f),
    ...
    val Download: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                ...
                stroke(1.8f, listOf(Offset(4f, 17f), Offset(4f, 19f), Offset(6f, 21f), Offset(18f, 21f), Offset(20f, 19f), Offset(20f, 17f))),
            ),
        )
    }
    ...
    val File: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            name = "Stroke.File",
            items = listOf(
                stroke(1.8f, listOf(Offset(7f, 3f),
                    Offset(14f, 3f),
                    Offset(19f, 8f),
                    Offset(19f, 21f),
                    Offset(7f, 21f),
    ...
    val Undo: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                ...
                stroke(1.8f, listOf(Offset(4f, 12f),
                    Offset(15f, 12f),
                    Offset(18.5f, 14.5f),
                    Offset(20f, 17f),
                    Offset(18.5f, 19.5f),
    ...
    val Redo: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                ...
                stroke(1.8f, listOf(Offset(20f, 12f),
                    Offset(9f, 12f),
                    Offset(5.5f, 14.5f),
                    Offset(4f, 17f),
                    Offset(5.5f, 19.5f),
    ...
    val Save: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            name = "Stroke.Save",
            items = listOf(
                stroke(1.8f, listOf(Offset(5f, 3f),
                    Offset(16f, 3f),
                    Offset(19f, 6f),
                    Offset(19f, 21f),
                    Offset(5f, 21f),
                ...
                stroke(1.8f, listOf(Offset(8f, 15f), Offset(8f, 21f), Offset(16f, 21f), Offset(16f, 15f), Offset(8f, 15f))),
            ),
        )
    }
    ...
    val Send: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            name = "Stroke.Send",
            items = listOf(
                stroke(1.8f, listOf(Offset(21f, 3f),
                    Offset(3f, 10.5f),
                    Offset(9.5f, 13f),
                    Offset(12f, 19.5f),
                    Offset(21f, 3f),)),
    ...
    val TaskList: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                stroke(1.8f, listOf(Offset(3f, 5.5f),
                    Offset(3f, 9.5f),
                    Offset(4.6f, 11f),
                    Offset(8.4f, 11f),
                    Offset(10f, 9.5f),
    ...
    val CodeBlock: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                stroke(1.8f, listOf(Offset(3f, 6f),
                    Offset(3f, 18f),
                    Offset(5f, 20f),
                    Offset(19f, 20f),
                    Offset(21f, 18f),
    ...
    val Formula: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                ...
                stroke(1.8f, listOf(Offset(8f, 4f),
                    Offset(7.25f, 8.75f),
                    Offset(5f, 12f),
                    Offset(7.25f, 15.25f),
                    Offset(8f, 20f),)),
    ...
    val Eye: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            name = "Stroke.Eye",
            items = listOf(
                stroke(1.8f, listOf(Offset(4.6f, 12f),
                    Offset(6.2f, 8f),
                    Offset(12f, 5.6f),
                    Offset(17.8f, 8f),
                    Offset(19.4f, 12f),
    ...
    val Image: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            name = "Stroke.Image",
            items = listOf(
                stroke(1.8f, listOf(Offset(3.5f, 4.5f),
                    Offset(20.5f, 4.5f),
                    Offset(20.5f, 19.5f),
                    Offset(3.5f, 19.5f),
                    Offset(3.5f, 4.5f),)),
                circ(9f, 9f, 1.5f),
                stroke(1.8f, listOf(Offset(4.8f, 17.8f),
                    Offset(9.5f, 13f),
                    Offset(13.5f, 17f),
                    Offset(17f, 14.8f),
                    Offset(19.5f, 17.8f),)),
    ...
    val Quote: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            ...
            items = listOf(
                ...
                stroke(2.4f, listOf(Offset(10.2f, 7.2f), Offset(13.2f, 7.2f), Offset(13.2f, 11.2f), Offset(10.2f, 13.4f))),
            ),
        )
    }
    ...
    val Braces: StrokeIconDef by lazy(LazyThreadSafetyMode.NONE) {
        StrokeIconDef(
            name = "Stroke.Braces",
            items = listOf(
                stroke(1.8f, listOf(Offset(8.5f, 4.5f),
                    Offset(6f, 4.5f),
                    Offset(6f, 9.5f),
                    Offset(8.5f, 12f),
                    Offset(6f, 14.5f),
                    Offset(6f, 19.5f),
                    Offset(8.5f, 19.5f),)),
                stroke(1.8f, listOf(Offset(15.5f, 4.5f),
                    Offset(18f, 4.5f),
                    Offset(18f, 9.5f),
                    Offset(15.5f, 12f),
                    Offset(18f, 14.5f),
